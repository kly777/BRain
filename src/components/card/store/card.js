...
export const useCardStore = defineStore("card", () => {
    ...
    async function addRelation(type, parent_id, child_id) {
    ...
    async function addRelationOf(type, id, main_id, relation) {
        if (relation === "parent") {
    ...
    async function updateRelation(id, type, parent_id, child_id) {
        try {
